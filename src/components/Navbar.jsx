...
import softyImage from "../assets/softylogo.png";
import isoText from "../assets/iso-text.png";

export default function Navbar() {
  return (
    <div className=" fixed z-2 w-full mx-auto bg-gradient-to-r from-purple-800 via-purple-600 to-pink-400 py-1 md:py-3 lg:py-1  ">
      <div className="flex justify-between items-center ml-4 mr-4">
        ...
        <div className=" flex md:hidden lg:flex xl:gap-50  lg:gap-30 sm:gap-50 gap-30 items-center ">
          ...
          <div>
            <img src={isoText} alt="iso-text" height={70} width={70} />
          </div>
        </div>
